...
[CreateAssetMenu(menuName = "Enemy/Actions/TranslateTheFlag")]
public class TranslateTheFlagAction : FSMAction
{
    public override void Execute(BaseStateMachine stateMachine)
    {
        ...
        navMeshAgent.SetDestination(enemyData.flagDepositLocation.transform.position);            
